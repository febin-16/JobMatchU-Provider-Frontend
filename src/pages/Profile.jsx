...
const Profile = () => {
  ...
  return (
    ...
    >
      ...
      <header className="flex w-full items-center justify-between border-b-2 border-gray-200 bg-gradient-to-r from-slate-800 to-slate-950  p-2">
        <div className="flex items-center space-x-2">
          <button
            onClick={() => setIsOpen(!isOpen)}
            type="button"
            className="text-3xl bg-gray-100"
          >
      ...
      <div className="flex">
        <aside
          className={`h-screen flex w-72  flex-col space-y-2 border-r-2 border-gray-200 bg-gray-900 p-2 ${
            isOpen ? "block" : "hidden"
          } md:block`}
          x-show="asideOpen"
        >
          ...
          <Link onClick={()=>setProf("Profile")}  className="flex items-center space-x-1 rounded-md px-2 py-3 hover:bg-gray-100 text-gray-100 hover:text-gray-900">
