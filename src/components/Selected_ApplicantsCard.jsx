            ...
            <div className="flex justify-between w-full min-h-[250px] h-auto md:h-[250px] border border-solid rounded-xl p-4 bg-gray-200 hover:shadow-md drop-shadow-md hover:shadow-gray-400">
				<div className=''>
					<div className="flex justify-between items-center py-3 ">
						<h2 className="text-2xl font-bold text-gray-900 mr-4">{details.student.first_name} {details.student.last_name}</h2>
					</div>
					<div className=''>
						<h3 className="flex flex-wrap text-xl font-large text-gray-900 pt-1">{details.student.student.email}</h3>
						<h3 className="flex flex-wrap text-xl font-large text-gray-900 pt-1">{details.student.phone_number}</h3>
						<h3 className="text-xl font-large text-gray-900 pb-1">Skills: {details.student.skills}</h3>
						...
						<div className="border-0 relative flex flex-col w-full outline-none focus:outline-none">
							<div className="relative  pl-4 py-4 md:p-6 flex-auto md:ml-8">
								...
								<div className='flex flex-col pl-6'>
									<h1 className='text-xl text-gray-800 py-1 pt-2'>{details.student.first_name} {details.student.last_name}</h1>
									<h1 className='text-xl text-gray-800 py-1'>{details.student.phone_number}</h1>
									<h1 className='text-xl text-gray-800 py-1'>{details.student.student.email}</h1>
									<h1 className='text-xl text-gray-800 py-1'>{details.student.first_name} {details.student.last_name}, {details.student.city}, {details.student.district} district, {details.student.state}</h1>
									<h1 className='text-xl text-gray-800 py-1'>{details.student.pincode}</h1>
								</div>
								<div className='flex flex-col border-b solid border-gray-400 pb-2'>
								...
								<div className='flex flex-col pl-6'>
									<h1 className='text-xl text-gray-800 py-1 pt-2'>{details.student.level_of_edu}</h1>
									<h1 className='text-xl text-gray-800 py-1'>{details.student.field_of_study}</h1>
									<h1 className='text-xl text-gray-800 py-1'>{details.student.skills}</h1>
								...
								<div className='flex flex-col pl-6'>
									<h1 className='text-xl text-gray-800 py-1 pt-2'>{details.student.job_title}</h1>
